...
class Style5 extends Admin_Render
{
    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'loader' => TRUE,
                'selector' => [
                    '{{WRAPPER}} .oxi-flip-box-col-style-5' => '',
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 *' => 'transition: all {{SIZE}}s;',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5' => 'max-width:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-section' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-headding' => 'color: {{VALUE}};',
                ]
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-headding' => '',
                ]
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-headding' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-info' => 'color: {{VALUE}};',
                ]
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'include' => Controls::ALIGNNORMAL,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-info' => '',
                ]
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-info' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'include' => Controls::ALIGNNORMAL,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => '',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'background: {{VALUE}};',
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'color: {{VALUE}};',
                ]
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'background: {{VALUE}};',
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#666666',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'color: {{VALUE}};',
                ]
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => '',
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-5 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
    ...
    public function modal_form_data()
    {
        ...
        $this->add_control(
            'sa_flip_back_overlay_color',
            $this->style,
            [
                'label' => __('Overlay Background', OXI_FLIP_BOX_TEXTDOMAIN),
