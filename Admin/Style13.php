        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
                      ...
                      <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" id="oxi-tabs-opening" name="oxi-tabs-opening">
                                ...
                                if ($styledata[75] == ':eq(0)') {
                                    echo 'selected';
                                };
                                ?>>First</option>
                                <option value=":eq(1)"     <?php
                                if ($styledata[75] == ':eq(1)') {
                                    echo 'selected';
                                };
                                ?>>2nd</option>
                                <option value=":eq(2)"     <?php
                                if ($styledata[75] == ':eq(2)') {
                                    echo 'selected';
                                };
                                ?>>3rd</option>
                                <option value=":eq(3)"     <?php
                                if ($styledata[75] == ':eq(3)') {
                                    echo 'selected';
                                };
                                ?>>4th</option>
                                <option value=":eq(4)"     <?php
                                if ($styledata[75] == ':eq(4)') {
                                    echo 'selected';
                                };
                                ?>>5th</option>
                                <option value=":eq(5)"     <?php
                                if ($styledata[75] == ':eq(5)') {
                                    echo 'selected';
                                };
                                ?>>6th</option>
                                <option value=":eq(6)"     <?php
                                if ($styledata[75] == ':eq(6)') {
                                    echo 'selected';
                                };
                                ?>>7th</option>
                                <option value=":eq(7)"     <?php
                                if ($styledata[75] == ':eq(7)') {
                                    echo 'selected';
                                };
                                ?>>8th</option>
                                <option value=":eq(8)"     <?php
                                if ($styledata[75] == ':eq(8)') {
                                    echo 'selected';
                                };
                                ?>>9th</option>
                                <option value=":eq(9)" <?php
                                if ($styledata[75] == ':eq(9)') {
                                    echo 'selected';
                                };
                                ?>>10th</option>
                                <option value=":eq(109)"    <?php
                                if ($styledata[75] == ':eq(109)') {
                                    echo 'selected';
                                };
                                ?>>None</option>
                            </select>
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" id="oxi-tabs-opening" name="oxi-tabs-animation">
                                ...
                                if ($styledata[77] == 'show') {
                                    echo 'selected';
                                };
                                ?>>No Animation</option>
                                <option value="fade"<?php
                                if ($styledata[77] == 'fade') {
                                    echo 'selected';
                                };
                                ?>>Fade</option>
                                <option value="slide"     <?php
                                if ($styledata[77] == 'slide') {
                                    echo 'selected';
                                };
                                ?>>Slide</option>
                            </select>
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        <label for="heading-width" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Customize your font Weight">Width </label>
                        <div class="col-sm-6 ">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo $styledata[21]; ?>" id="heading-margin-right" name="heading-margin-right">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo $styledata[23]; ?>" id="heading-margin-bottom" name="heading-margin-bottom">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        <label for="heading-border-radius" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Add Rounded Corner Around Title, Based on Pixel">Border Radius </label>
                        <div class="col-sm-6 ">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        <label for="content-font-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Set Your content Font Color, Based on Color">Color </label>
                        <div class="col-sm-6 ">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="oxi-admin-font" value="<?php echo $styledata[47]; ?>" type="text" name="content-font-familly" id="content-font-familly">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        <label for="content-background-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Set Your content background Color, Based on Color">Background Color </label>
                        <div class="col-sm-6 ">
                            <input type="text"  data-format="rgb" data-opacity="true"  class="form-control oxilab-vendor-color" id="content-background-color" name="content-background-color" value="<?php echo $styledata[35]; ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo $styledata[53]; ?>" id="content-border-radius" name="content-border-radius">
                        </div>
                    </div>
                </div>
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo $styledata[55]; ?>" id="content-box-shadow-Blur" name="content-box-shadow-Blur">
                        </div>
                        <div class="col-sm-3">
