...
class Style22 extends Admin_Render {
    ...
    public function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'include' => Controls::ALIGNNORMAL,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => '',
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button' => '',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'background: {{VALUE}};',
            ]
                ]
        );
        $this->add_control(
            ...
            'default' => '#0aa8a3',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'color: {{VALUE}};',
            ]
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls::COLOR,
            'oparetor' => 'RGB',
            'default' => 'rgba(10, 96, 97, 1)',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'background: {{VALUE}};',
            ]
                ]
        );
        $this->add_control(
            ...
            'default' => '#ffffff',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'color: {{VALUE}};',
            ]
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => '',
            ]
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
    ...
    public function modal_form_data() {
        ...
        $this->add_control(
            ...
            'label' => __('Overlay Color', OXI_FLIP_BOX_TEXTDOMAIN),
