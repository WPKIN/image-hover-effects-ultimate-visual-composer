...
background-size: 100% 100%;
            ...
            $this->inline_css .= '.oxilab-flip-box-padding-' . $styleid . '{
                ...
                .oxilab-flip-box-' . $styleid . '-data .oxilab-heading{
                    ...
                    position: relative;
                    color: ' . $styledata[13] . ';
                    text-align: ' . $styledata[167] . ';
                    font-size: ' . $styledata[159] . 'px;
                    font-family: ' . $this->font_familly($styledata[161]) . ';
                    font-weight: ' . $styledata[165] . ';
                    font-style:' . $styledata[163] . ';
                    padding:' . $styledata[169] . 'px ' . $styledata[175] . 'px ' . $styledata[171] . 'px ' . $styledata[173] . 'px;
                }
                .oxilab-flip-box-' . $styleid . '-data .oxilab-heading .oxilab-span{
                    ...
                    height: ' . $styledata[77] . 'px;
                }
                .oxilab-flip-box-' . $styleid . '-data .oxilab-info{
                    display: block;
                    color: ' . $styledata[17] . ';
                    text-align: ' . $styledata[87] . ';
                    font-size: ' . $styledata[79] . 'px;
                    font-family: ' . $this->font_familly($styledata[81]) . ';
                    font-weight: ' . $styledata[85] . ';
                    font-style:' . $styledata[83] . ';
                    padding:' . $styledata[89] . 'px ' . $styledata[93] . 'px ' . $styledata[91] . 'px ' . $styledata[93] . 'px;
