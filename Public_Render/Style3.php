...
background-size: 100% 100%;
            ...
            $this->inline_css .= '.oxilab-flip-box-padding-' . $styleid . '{
                ...
                .oxilab-flip-box-' . $styleid . '-data .oxilab-info{
                    display: block;
                    color: ' . $styledata[17] . ';
                    text-align: ' . $styledata[109] . ';
                    font-size: ' . $styledata[101] . 'px;
                    font-family: ' . $this->font_familly($styledata[103]) . ';
                    font-weight: ' . $styledata[107] . ';
                    font-style:' . $styledata[105] . ';
                    padding: ' . $styledata[111] . 'px ' . $styledata[117] . 'px ' . $styledata[113] . 'px ' . $styledata[115] . 'px;
                }
