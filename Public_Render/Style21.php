...
class Style21 extends Public_Render {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo'<div class="oxi-flip-box-col-21 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '" >
                                                ...
                                                <div class="oxi-addons-flip-box-front">
                                                    <div class="oxi-addons-flip-box-front-section-box">
                                                        <div class="oxi-addons-flip-box-front-section oxi-addons-flip-box-front-section-' . $val['id'] . '">
                                                            <div class="oxi-addons-flip-box-front-section-overlay-image">
                                                            ' . $image . '
                                                            </div>
                                                            <div class="oxi-addons-flip-box-front-section-overlay">
                                                            ' . $icon . ' 
                                                            ' . $heading . '
                                                            </div>
                                                        </div>  
            ...
            echo ' </div>';
            $this->inline_css .= '.' . $this->WRAPPER . ' .oxi-addons-flip-box-style-21 .oxi-addons-flip-box-front-section-' . $val['id'] . ' .oxi-addons-flip-box-front-section-overlay-image:before{
