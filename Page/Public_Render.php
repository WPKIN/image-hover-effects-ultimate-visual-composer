...
class Public_Render {
    ...
    public function public_jquery_css() {
        ...
        wp_enqueue_style('vc-tabs-style', OXI_FLIP_BOX_URL . '/Assets/Frontend/css/style.css', false, OXI_FLIP_BOX_TEXTDOMAIN);
        wp_enqueue_script('vc-tabs-jquery', OXI_FLIP_BOX_URL . '/Assets/Frontend/js/tabs.js', false, OXI_FLIP_BOX_TEXTDOMAIN);
    }
