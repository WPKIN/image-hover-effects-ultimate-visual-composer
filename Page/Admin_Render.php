...
class Admin_Render {
    ...
    public function admin_load() {
        wp_enqueue_style('jquery.minicolors', OXI_FLIP_BOX_URL . '/Assets/Backend/css/minicolors.css', false, OXI_FLIP_BOX_TEXTDOMAIN);
        wp_enqueue_style('jquery.fontselect', OXI_FLIP_BOX_URL . '/Assets/Backend/css/jquery.fontselect.css', false, OXI_FLIP_BOX_TEXTDOMAIN);
        wp_enqueue_script('jquery.minicolors', OXI_FLIP_BOX_URL . '/Assets/Backend/js/minicolors.js', false, OXI_FLIP_BOX_TEXTDOMAIN);
        wp_enqueue_script('oxi-flip-box-editor', OXI_FLIP_BOX_URL . '/Assets/Backend/js/shortcode.js', false, OXI_FLIP_BOX_TEXTDOMAIN);
                ...
                <div class="oxi-addons-wrapper ">
                    ...
                    <div class="oxi-addons-style-left-preview">
                        ...
                        <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                            ...
                            $C = 'OXI_FLIP_BOX_PLUGINS\Public_Render\\' . $style;
                            if (class_exists($C)):
